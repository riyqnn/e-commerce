            ...
            <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('category.edit',$item->id) }}" class="btn btn-primary mb-5"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('category.delete',$item->id) }}" class="btn btn-danger mb-5" id="delete"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
               </tbody>
