                            ...
                            <tbody>
                                @foreach ($subcategory as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subcategory.edit', $item->id) }}" class="btn btn-primary mb-5">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{ route('subcategory.delete', $item->id) }}" class="btn btn-danger mb-5" id="delete">
