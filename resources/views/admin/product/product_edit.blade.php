                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ $products->product_tags_en}}" data-role="tagsinput" placeholder="add tags"/>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ $products->product_tags_ind}}" data-role="tagsinput" placeholder="add tags"/>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ $products->product_size_ind}}" data-role="tagsinput" placeholder="add tags"/>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ $products->product_color_en}}" data-role="tagsinput" placeholder="add tags"/>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ $products->product_color_ind}}" data-role="tagsinput" placeholder="add tags"/>
            ...
            <div class="box bt-3 border-info">
                ...
                <div class="box-body">
                    <form method="post" action="{{route('images.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <a href="{{route('product.imgs.delete',$img->id )}}" class="btn btn-danger" id="delete" title="Delete Image"><i class="fa fa-trash"></i></a>
                                        </h5>
                                        <p class="card-text">
                                            <div class="form-group">
                        ...
                        <div class="text-xs-right">
                            <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Multiple Image">                        </div>
                    </form>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">
                                            <div class="form-group">
                                                <label class="form-control-label">Change Thambnail <span class="text-danger">*</span></label>
    ...
    $(document).ready(function(){
        $('#multiImg').on('change',function(){
            if(window.File && window.FileReader && window.FileList && window.Blob){
                ...
                // Menghapus pratinjau gambar sebelumnya agar tidak menumpuk
                $('#preview_img').empty();
